          ...
          <div className="hidden md:flex items-center space-x-4">
            <DropdownMenu title="Services" isOpen={openDropdown === 'Services'} toggleDropdown={toggleDropdown}>
              <div className="space-y-1">
                ...
                {/* Services d'Affaires */}
                <div className="px-4 py-2">
                  <h3 className="text-sm font-semibold text-white dark:text-[#F8E061]">Services d'Affaires</h3>
                  <div className="mt-1 space-y-1">
                ...
                <div className="px-4 py-2">
                  <h3 className="text-sm font-semibold text-white dark:text-[#F8E061]">Énergie et Environnement</h3>
                  <div className="mt-1 space-y-1">
                ...
                <div className="px-4 py-2">
                  <h3 className="text-sm font-semibold text-white dark:text-[#F8E061]">Formations Professionnelles</h3>
                  <div className="mt-1 space-y-1">
                ...
                <div className="px-4 py-2">
                  <h3 className="text-sm font-semibold text-white dark:text-[#F8E061]">Consultance et Accompagnement</h3>
                  <div className="mt-1 space-y-1">
...
const DropdownMenu = ({ title, isOpen, toggleDropdown, children }: DropdownMenuProps) => {
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute left-0 mt-2 w-56 rounded-md shadow-lg bg-[#040504] border border-[#F8E061] z-50 dropdown-menu">
          <div className="py-1">
            {children}
          </div>
        </div>
